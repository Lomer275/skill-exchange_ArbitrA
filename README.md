...
| [env-audit](plugins/team-skills/skills/env-audit/README.md) | Костя | audit, agents, secrets, resources, process | Аудит рабочего окружения и процессов: что инструкция обещает агенту против того, что он реально загружает, где лежат секреты, чем занят ресурс, как ведётся работа |
