...
| [env-audit](plugins/team-skills/skills/env-audit/README.md) | Костя | audit, onboarding, agents, secrets, resources, process | Приёмка рабочего места: одиннадцать регламентов команды — обменник, скиллы, структура docs, GitHub, память и правила Claude, связка с Codex, Docker, регламент Битрикса, принципы, анкета человека, superpowers. Одно разрешение на весь прогон, профили Claude и Codex, в финале — инструкция человеку |
